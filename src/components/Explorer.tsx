      ...
      <div>
        <ul>
          <li>
            ...
            <ul className="ml-4">
              <li className="flex items-center gap-x-1"><span><Image src={rightArrow} alt='expand folder'/></span><img
                className="h-[1.2em]"
              ...
              <li className="ml-5"><Link href={'/readme'} className="flex items-center gap-x-1"
                                         onClick={() => dispatch(addTab('/readme'))}><span className="text-blue-500"><svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
                viewBox="0 0 16 16"
              ...
              <li className="flex items-center gap-x-1 ml-5"><span className="text-yellow-500"><svg
                ...
                <p className="w-fit h-fit">package.json</p>
              </li>
            </ul>
          </li>
        </ul>
