...
export default function SideBar({value, setVisible}: SideBarProps) {
    ...
    <div>
      ...
      >
        <motion.div
          ...
          className="flex flex-col fixed pt-1 max-md:ml-0 max-md:left-0 -ml-[6px] pr-1 h-full left-[74px] w-fit bg-secondary text-base">
              ...
              <li>
                <div className="flex items-center gap-x-1"><span><Image src={downArrow} alt='close folder'/></span>
                  <div className="flex justify-between items-center">
                    <Link href={'/'}>
                      <p className="font-semibold text-xl text-purple">PORTFOLIO</p>
                    </Link>
                ...
                <ul className="ml-4">
                  <li className="flex items-center gap-x-1"><span><Image src={rightArrow}
                                                                         alt='expand folder'/></span><img
                    className="h-[1.2em]"
                    ...
                    alt=""/><p className="text-xl">node_modules</p></li>
                  <li className="flex items-center gap-x-1"><span><svg stroke="currentColor"
                    ...
                    alt=""/><p className="text-xl">public</p></li>
                  <li>
                    <div className="flex items-center gap-x-1"><span><Image src={rightArrow}
                                                                            alt='expand folder'/></span><img
                      className="h-[1.2em]"
                    ...
                    <ul className="ml-8">
                      <li className="text-purple font-semibold cursor-pointer"><Link href={'/stack'}
                        ...
                        <p className="text-xl">Stack.tsx</p></Link>
                      </li>
                      <li className="text-purple font-semibold cursor-pointer"><Link href={'/works'}
                                                                                     className="flex items-center gap-x-1"
                                                                                     onClick={() => {
                                                                                       dispatch(addTab('/works'))
                                                                                       handleClose()
                                                                                     }}><img
                        className="h-[1.2em]"
                        src="https://raw.githubusercontent.com/vscode-icons/vscode-icons/master/icons/file_type_reactjs.svg"
                        alt="Icon file.jsx" loading="lazy"/>
                        <p className="text-xl">Works.tsx</p></Link>
                      </li>
                    </ul>
                  </li>
                  <li className="flex items-center gap-x-1 ml-5"><img className="h-[1.2em]"
                                                                      src="https://raw.githubusercontent.com/vscode-icons/vscode-icons/master/icons/file_type_git.svg"
                                                                      alt="Icon .gitignore" loading="lazy"/>
                    <p className="text-xl">.gitignore</p>
                  </li>
                  <li className="ml-5"><Link href={'/readme'} className="flex items-center gap-x-1"
                                             onClick={() => {
                                               dispatch(addTab('/readme'))
                                               handleClose()
                                             }}><span
                    className="text-blue-500"><svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    ...
                    <p className="text-purple font-semibold cursor-pointer text-xl">README.md</p></Link>
                  </li>
                  <li className="flex items-center gap-x-1 ml-5"><span className="text-yellow-500"><svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    ...
                    <p className="text-xl">package.json</p>
                  </li>
                </ul>
              </li>
            </ul>
