...
const Navbar = () => {
  return (
    <nav className="flex flex-col justify-between items-center w-16 bg h-full bg-secondary absolute pb-6">
      <div className="flex flex-col w-full">
        <div className="border-l-2 border-fuchsia-400 h-14 flex justify-center items-center">
